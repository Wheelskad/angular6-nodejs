...
/* harmony import */ var _providers_luis_service__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./providers/luis.service */ "../src/app/providers/luis.service.ts");
var __decorate = (undefined && undefined.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var AppModule = /** @class */ (function () {
    ...
    AppModule = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
            ...
            providers: [_providers_luis_service__WEBPACK_IMPORTED_MODULE_9__["LuisService"]],
...
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @angular/core */ "../node_modules/@angular/core/fesm5/core.js");
/* harmony import */ var _providers_luis_service__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../providers/luis.service */ "../src/app/providers/luis.service.ts");
var __decorate = (undefined && undefined.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var HomeComponent = /** @class */ (function () {
    function HomeComponent(luisService) {
        this.luisService = luisService;
        this.strValue = '';
    }
    HomeComponent.prototype.ngOnInit = function () {
        var _this = this;
        this.luisService.getLogs().subscribe(function (res) {
            console.log(res);
            var luisData = res;
            _this.strValue = luisData.value;
        }, function (err) {
            console.log(err);
        });
    };
    HomeComponent = __decorate([
        ...
        __metadata("design:paramtypes", [_providers_luis_service__WEBPACK_IMPORTED_MODULE_1__["LuisService"]])
    ], HomeComponent);
...
/***/ "../src/app/providers/luis.service.ts":
/*!********************************************!*\
  !*** ../src/app/providers/luis.service.ts ***!
  \********************************************/
...
var LuisService = /** @class */ (function () {
    function LuisService(http) {
        this.http = http;
    }
    LuisService.prototype.getLogs = function () {
...
module.exports = __webpack_require__(/*! C:\workspace\formation\angular-nodejs-master\client\src\main.ts */"../src/main.ts");
